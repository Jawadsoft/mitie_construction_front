...
export class NotificationsService {
  ...
  async summary(): Promise<{ items: NotificationItem[] }> {
    const items: NotificationItem[] = [];

    const lowStock: { id: string; name: string; current_stock: string; min_stock_level: string }[] =
    ...
    const budget: { id: string; name: string; budget: string; spent: string }[] =
      await this.dataSource.query(`
    ...
    const mrs: { id: string; request_no: string; status: string; created_at: string }[] =
      await this.dataSource.query(`
    ...
    const overdue: { id: string; sale_id: string; due_date: string; due_amount: string; customer: string }[] =
      await this.dataSource.query(`
