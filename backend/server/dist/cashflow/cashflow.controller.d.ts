...
export declare class CashflowController {
    ...
    findAll(project_id?: string, type?: string, from?: string, to?: string): Promise<any>;
    create(dto: any): Promise<import("./entities/cash-transaction.entity").CashTransaction | null>;
