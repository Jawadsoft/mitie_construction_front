...
export declare class CashflowService {
    ...
    constructor(repo: Repository<CashTransaction>, ds: DataSource, accounting: AccountingService);
    private cashBankAccountFilter;
    findAll(filters: {
        project_id?: string;
        type?: string;
        from?: string;
    ...
    private postCashJournal;
    private clearCashJournal;
    create(dto: Partial<CashTransaction>): Promise<CashTransaction | null>;
