...
const sell_during_construction_dto_1 = require("./dto/sell-during-construction.dto");
...
let ProjectsController = class ProjectsController {
    ...
    findAll(lifecycle) {
        const lc = lifecycle === 'archived' || lifecycle === 'deleted' ? lifecycle : 'active';
...
__decorate([
    (0, common_1.Get)(),
    __param(0, (0, common_1.Query)('lifecycle')),
...
__decorate([
    (0, common_1.Post)(':id/sell-during-construction'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, sell_during_construction_dto_1.SellDuringConstructionDto]),
    __metadata("design:returntype", void 0)
], ProjectsController.prototype, "sellDuringConstruction", null);
__decorate([
