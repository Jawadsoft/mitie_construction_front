...
let SalesController = class SalesController {
    ...
    findSales(project_id, customer_id) {
    ...
    collectOnSale(id, dto) {
        return this.svc.collectOnSale(id, dto);
    }
    adjustCollection(id, dto) {
    ...
    recordPayment(id, dto) {
        return this.svc.recordPayment(id, dto.paid_amount, dto.paid_date, dto.bank_account_id);
    }
    setInstallmentBank(id, dto) {
...
__decorate([
    (0, common_1.Post)('list/:id/collect'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", void 0)
], SalesController.prototype, "collectOnSale", null);
__decorate([
    (0, common_1.Patch)('list/:id/collection'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", void 0)
], SalesController.prototype, "adjustCollection", null);
__decorate([
...
__decorate([
    (0, common_1.Patch)('installments/:id/bank'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", void 0)
], SalesController.prototype, "setInstallmentBank", null);
