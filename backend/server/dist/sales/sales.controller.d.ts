...
export declare class SalesController {
    ...
    collectOnSale(id: string, dto: any): Promise<{
        installments: import("./entities/sale-installment.entity").SaleInstallment[];
        id: string;
        property_unit_id: string;
        customer_id: string;
    ...
    adjustCollection(id: string, dto: any): Promise<{
        installments: import("./entities/sale-installment.entity").SaleInstallment[];
        id: string;
        property_unit_id: string;
        customer_id: string;
    ...
    setInstallmentBank(id: string, dto: {
        bank_account_id?: string | null;
    }): Promise<import("./entities/sale-installment.entity").SaleInstallment | null>;
}
